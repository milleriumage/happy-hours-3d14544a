...
//[FIX] Check the type of the `cls` parameter to correctly call the overloaded `utils.resource` method.
		if (typeof cls === 'function') {
			return this.utils.resource(url, cls, config);
		}
		return this.utils.resource(url, cls);
	}
...
//[FIX] Check the type of the `cls` parameter to correctly call the overloaded `utils.resources` method.
		if (typeof cls === 'function') {
			return this.utils.resources(url, cls, config);
		}
		return this.utils.resources(url, cls);
	}
}
